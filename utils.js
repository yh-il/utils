 ...
 * 日付フォーマットを変換する
 */
'2020-03-19'.replace(/-/g, '').replace(/(\d{4})(\d{2})(\d{2})/, '$1年$2月$3日');
 ...
 */
 dummy = {
    callLogs: [
      ['2018/01/31', '23:33:32', '090-1234-5678', '1時間33分25秒5'],
      ['2018/02/01', '23:33:33', '090-1234-5679', '1時間33分25秒6'],
      ['2018/02/02', '23:33:34', '090-1234-5680', '1時間33分25秒7'],
      ['2018/02/03', '23:33:35', '090-1234-5681', '1時間33分25秒8'],
    ].map(([date, time, toPhoneNumber, durationTime]) => ({date, time, toPhoneNumber, durationTime}))
  };
